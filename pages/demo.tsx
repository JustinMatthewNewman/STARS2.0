...
export default function DemoPage() {
   ...
   */
  const [selectedCollege, setSelectedCollege] = useState(college[0])
   ...
   * Code from template
   */
  const [selected, setSelected] = useState(graphics[0]);
              ...
              >
                <div className="flex flex-row items-center space-x-1">
                  ...
                  <p className="text-[14px] font-normal leading-[20px] text-[#1a2b3b]">
                    Graphics are not stored on our servers, and will go away as soon
              ...
              {step === 1 ? (
                ...
                >
                  ...
                  <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal my-4">
                    We have hundreds of graphic presets.
                ...
                >
                  ...
                  <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal my-4">
                    Choose your college. You can always
              ...
              >
                <ul className="mb-auto list-none">
                  ...
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    ...
                    <p className="ml-[3px] mr-[6px]">Graphics Vault</p>
                  ...
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    ...
                    <p className="ml-[3px] mr-[6px]">My Graphics</p>
                  </li>
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    <svg
                      className="h-4 w-4 text-gray-700"
              ...
              <div className="bg-white text-[#667380] p-[18px] flex flex-col">
                {step === 1 ? (
                  <div>
                    ...
                    >
                      {selected.name} Graphics
                    </motion.span>

                    <ul className="mt-[28px] flex">
                      <li className="list-none max-w-[400px]">
                        Search through all of the graphics in the graphic
                        bank. If you don{`'`}t see one you{`'`}re looking for,
                        you can always add it in your the {`"`}My Graphics{`"`}{" "}
                        section.
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="mt-[28px] flex">
                        <li className="list-none max-w-[400px]">
                          We can process the whole team in seconds.
                        </li>
                    </ul>
                  </div>
                )}
                {step === 2 && (
                  ...
                  >
                    ...
                    {selectedCollege === "James Madison University" ? (
                      <motion.img
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: -10 }}
                      ...
                      />
                    ) : selectedCollege === "Oklahoma State University" ? (
                      <motion.img
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: -10 }}
                        transition={{ duration: 0.5, ease: [0.23, 1, 0.32, 1] }}
                        key="Richard"
                        src="/placeholders/Osu.webp"
                        alt="Richard's Interviewer Profile"
                        className="absolute top-6 left-6 w-[30%] aspect-video bg-gray-700 rounded ring-1 ring-gray-900/5 shadow-md object-cover"
                      />
                    ) : selectedCollege === "University of North Carolina Wilmington" ? (
                      <motion.img
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: -10 }}
                        ...
                        <div className="group relative w-full">
                          <div className="relative mb-2 flex h-full max-h-[200px] w-full cursor-pointer items-start justify-between rounded-lg p-2 font-medium transition duration-100">
                            ...
                            <div className="relative flex h-full flex-col overflow-hidden">
                              ...
                              <p className="text-wrap grow font-normal text-[7px]">
                                - {selected.name} style graphics set.
                              </p>
                              <div className="flex flex-row space-x-1">
                                <p className="inline-flex items-center justify-center truncate rounded-full border-[0.5px] border-gray-300 px-[3px] text-[7px] font-normal hover:bg-gray-50">
                                  Basketball 2023
